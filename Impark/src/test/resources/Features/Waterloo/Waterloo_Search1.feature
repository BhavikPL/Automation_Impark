...
When user click on to the "Support Notes" link of "search_number" citation number ticket
And user wait for "2" seconds
...
And user wait for "5" seconds
And user click on to the "Support Notes" link of "search_number" citation number ticket
